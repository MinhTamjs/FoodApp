...
public class FoodListAdapter extends RecyclerView.Adapter<FoodListAdapter.viewholder> {
    ...
    public class viewholder extends RecyclerView.ViewHolder{
        ...
        public viewholder(@NonNull View itemView){
            ...
            titleTxt = itemView.findViewById(R.id.listTitleTxt);
            priceTxt = itemView.findViewById(R.id.listPriceTxt);
            starTxt = itemView.findViewById(R.id.rateTxt);
            timeTxt = itemView.findViewById(R.id.listTimeTxt);
            pic = itemView.findViewById(R.id.listImg);
